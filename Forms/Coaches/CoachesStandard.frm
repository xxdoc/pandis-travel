...
Begin VB.Form CoachesStandard 
   ...
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":0000
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":059A
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":0B34
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":10CE
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":1668
      PicSizeH        =   16
      PicSizeW        =   16
   End
   Begin Dacara_dcButton.dcButton cmdIndex 
      ...
      EndProperty
      ForeColor       =   0
      PicNormal       =   "CoachesStandard.frx":1C02
      PicSizeH        =   16
      PicSizeW        =   16
   End
   ...
   End
End
Attribute VB_Name = "CoachesStandard"
...
Private Function AbortProcedure(blnStatus)
    ...
    If Not blnStatus Then
        If MyMsgBox(3, strAppTitle, strStandardMessages(3), 2) Then
            blnStatus = False
            blnCancel = True
            ClearFields txtTransferID, mskDate, txtCompanyID, txtCompanyDescription, txtTransferTypeID, txtTransferTypeDescription, txtPickupPointID, txtPickupPointDescription, txtRouteID, txtRouteShortDescription, mskAdults, mskKids, mskFree, mskTotal, txtDestinationID, txtDestinationDescription, txtRemarks, lblWeekday
            DisableFields mskDate, txtCompanyDescription, txtTransferTypeDescription, txtPickupPointDescription, txtRouteDescription, txtRouteShortDescription, mskAdults, mskKids, mskFree, txtDestinationDescription, txtRemarks, cmdIndex(0), cmdIndex(1), cmdIndex(2), cmdIndex(3), cmdIndex(4), cmdIndex(5)
...
Private Function DeleteRecord()
    ...
    If MainDeleteRecord("CommonDB", "Transfers", strAppTitle, "ID", txtTransferID.text, "True") Then
        blnCancel = True
        ClearFields txtTransferID, mskDate, txtCompanyID, txtCompanyDescription, txtTransferTypeID, txtTransferTypeDescription, txtPickupPointID, txtPickupPointDescription, txtRouteID, txtRouteShortDescription, mskAdults, mskKids, mskFree, mskTotal, txtDestinationID, txtDestinationDescription, txtRemarks
        DisableFields mskDate, txtCompanyDescription, txtTransferTypeDescription, txtPickupPointDescription, txtRouteDescription, txtRouteShortDescription, mskAdults, mskKids, mskFree, txtDestinationDescription, txtRemarks, cmdIndex(0), cmdIndex(1), cmdIndex(2), cmdIndex(3), cmdIndex(4), cmdIndex(5)
        UpdateButtons Me, 5, 1, 0, 0, IIf(CheckForLoadedForm("ΜεταφορέςΗμερολόγιο"), 0, 1), 0, 1
    End If
...
Private Function FindRecords()
    ...
    With CoachesPickupsReport
        .Tag = "True"
        .txtRefersTo.text = txtRefersTo.text
        .txtCallingForm.text = "Transactions"
        .grdΗμερολόγιοΜεταφορών.Tag = "grdΗμερολόγιοΜεταφορώνΚανονικό"
        .Show 1, Me
    End With
...
Private Function SaveRecord()
    ...
    If MainSaveRecord("CommonDB", "Transfers", blnStatus, strAppTitle, "ID", txtTransferID.text, mskDate.text, txtCompanyID.text, txtTransferTypeID.text, txtPickupPointID.text, txtRouteID.text, mskAdults.text, mskKids.text, mskFree.text, txtDestinationID.text, "", txtRemarks.text, 1, strCurrentUser) <> 0 Then
        blnCancel = True
        ClearFields txtTransferID, mskDate, txtCompanyID, txtCompanyDescription, txtTransferTypeID, txtTransferTypeDescription, txtPickupPointID, txtPickupPointDescription, txtRouteID, txtRouteShortDescription, mskAdults, mskKids, mskFree, mskTotal, txtDestinationID, txtDestinationDescription, txtRemarks, lblWeekday
        DisableFields mskDate, txtCompanyDescription, txtTransferTypeDescription, txtPickupPointDescription, txtRouteDescription, txtRouteShortDescription, mskAdults, mskKids, mskFree, txtDestinationDescription, txtRemarks, cmdIndex(0), cmdIndex(1), cmdIndex(2), cmdIndex(3), cmdIndex(4), cmdIndex(5)
...
Private Function NewRecord()
    ...
    blnCancel = False
    ClearFields txtTransferID, mskDate, txtCompanyID, txtCompanyDescription, txtTransferTypeID, txtTransferTypeDescription, txtPickupPointID, txtPickupPointDescription, txtRouteID, txtRouteShortDescription, mskAdults, mskKids, mskFree, mskTotal, txtDestinationID, txtDestinationDescription, txtRemarks
    EnableFields mskDate, txtCompanyDescription, txtTransferTypeDescription, txtPickupPointDescription, txtRouteShortDescription, mskAdults, mskKids, mskFree, txtDestinationDescription, txtRemarks, cmdIndex(0), cmdIndex(1), cmdIndex(2), cmdIndex(3), cmdIndex(4), cmdIndex(5)
...
Private Sub cmdIndex_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1
            'Πελάτης
            Set tmpRecordset = CheckForMatch("CommonDB", txtCompanyDescription.text, "Companies", "CompanyDescription", "String", "1")
        ...
        Case 2
            'Τύπος μετακίνησης
            Set tmpRecordset = CheckForMatch("CommonDB", txtTransferTypeDescription.text, "TransferTypes", "TransferTypeDescription", "String", "1")
            tmpTableData = DisplayIndex(tmpRecordset, 2, True, 2, 0, 1, "ID", "Περιγραφή", 0, 40, 1, 0)
...
Public Function SeekRecord(myTransferID, myRefersTo)
    ...
    If MainSeekRecord("CommonDB", "Transfers", "ID", myTransferID, True, txtTransferID, mskDate, txtCompanyID, txtTransferTypeID, txtPickupPointID, txtRouteID, mskAdults, mskKids, mskFree, txtDestinationID, txtPickupPointDescription, txtRemarks) Then
        'Πελάτης
        ...
        'Τύπος μετακίνησης
        Set tmpRecordset = CheckForMatch("CommonDB", txtTransferTypeID.text, "TransferTypes", "TransferTypeID", "Numeric", 1)
        ...
        'Δρομολόγιο - 2 από 3
        Set tmpRecordset = CheckForMatch("CommonDB", txtRouteID.text, "PickupRoutes", "RouteID", "Numeric", 1)
        ...
        Set tmpRecordset = CheckForMatch("CommonDB", txtPickupPointID.text, "PickupPoints", "PickupPointID", "Numeric", 0)
