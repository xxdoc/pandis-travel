...
Private Function DeleteRecord()
    ...
    If MainDeleteRecord("CommonDB", "Banks", strAppTitle, "BankID", txtBankID.text, "True") Then
        PopulateGrid
...
Private Function SaveRecord()
    ...
    If MainSaveRecord("CommonDB", "Banks", blnStatus, strAppTitle, "BankID", txtBankID.text, txtBankDescription.text, txtBankAccountsCode.text, 1, strCurrentUser) <> 0 Then
        PopulateGrid
...
Private Sub Form_Activate()
    ...
    If Me.Tag = "True" Then
        Me.Tag = "False"
        AddColumnsToGrid grdBanks, 25, GetSetting(strAppTitle, "Layout Strings", "grdBanks"), "04NCIID,40NLNDescription", "ID,Ονομασία"
        Me.Refresh
        PopulateGrid
    End If
...
Private Sub mnuΑποθήκευσηΠλάτουςΣτηλών_Click()
    ...
    SaveSetting strAppTitle, "Layout Strings", "grdBanks", grdBanks.LayoutCol
