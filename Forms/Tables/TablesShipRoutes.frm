...
Begin VB.Form TablesShipRoutes 
   ...
   Begin VB.Label lblLabel 
      BackColor       =   &H000080FF&
      Caption         =   "Λιμένας τελικού προορισμού"
      BeginProperty Font 
         Name            =   "Ubuntu Condensed"
         Size            =   9.75
         Charset         =   161
   ...
   Begin VB.Label lblLabel 
      BackColor       =   &H000080FF&
      Caption         =   "Ενδιάμεσοι λιμένες προσέγγισης"
      BeginProperty Font 
         Name            =   "Ubuntu Condensed"
         Size            =   9.75
         Charset         =   161
...
Private Function DeleteRecord()
    ...
    If MainDeleteRecord("CommonDB", "Routes", strAppTitle, "RouteID", txtRouteID.text, "True") Then
        PopulateGrid
...
Private Function SaveRecord()
    ...
    If MainSaveRecord("CommonDB", "Routes", blnStatus, strAppTitle, "RouteID", txtRouteID.text, txtRouteDescription.text, txtRouteFrom.text, txtRouteVia.text, txtRouteTo.text, txtRouteDepartureTime.text, 1, strCurrentUser) <> 0 Then
        PopulateGrid
...
Private Sub Form_Activate()
    ...
    If Me.Tag = "True" Then
        Me.Tag = "False"
        AddColumnsToGrid grdShipRoutes, 25, GetSetting(strAppTitle, "Layout Strings", "grdShipRoutes"), "04NCIID,40NLNShortDescription,40NLNFrom,40NLNVia,40NLNTo,06NCTTime", "ID,Συντ.,Λιμένας εκκίνησης,Ενδιάμεσοι λιμένες προσέγγισης,Λιμένας τελικού προορισμού,Ώρα"
        Me.Refresh
        PopulateGrid
    End If
...
Private Sub mnuΑποθήκευσηΠλάτουςΣτηλών_Click()
    ...
    SaveSetting strAppTitle, "Layout Strings", "grdShipRoutes", grdShipRoutes.LayoutCol
