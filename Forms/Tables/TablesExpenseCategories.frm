...
Begin VB.Form TablesExpenseCategories 
   Appearance      =   0  'Flat
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   ClientHeight    =   9015
   ...
   Begin VB.Frame frmInfo 
      ...
      Begin vbalIml6.vbalImageList lstIconList 
         ...
         _ExtentY        =   953
         Size            =   4592
         Images          =   "TablesExpenseCategories.frx":0000
         Version         =   131072
         KeyCount        =   4
         Keys            =   "ÿÿÿ"
      End
   ...
   End
End
Attribute VB_Name = "TablesExpenseCategories"
...
Private Function DeleteRecord()
    ...
    If MainDeleteRecord("CommonDB", "ExpensesCategories", strAppTitle, "ExpenseCategoryID", txtExpenseCategoryID.text, "True") Then
        PopulateGrid
        HighlightRow grdExpenseCategories, lngSelectedRow, 1, "", True
        ClearFields txtExpenseCategoryID, txtExpenseCategoryDescription
        DisableFields txtExpenseCategoryDescription
        UpdateButtons Me, 4, 1, 0, 0, 0, 1
    End If
...
Private Function SaveRecord()
    ...
    If MainSaveRecord("CommonDB", "ExpensesCategories", blnStatus, strAppTitle, "ExpenseCategoryID", txtExpenseCategoryID.text, txtExpenseCategoryDescription.text, 1, strCurrentUser) <> 0 Then
        PopulateGrid
        HighlightRow grdExpenseCategories, lngSelectedRow, 2, txtExpenseCategoryDescription.text, True
        lngSelectedRow = 0
        ClearFields txtExpenseCategoryID, txtExpenseCategoryDescription
        DisableFields txtExpenseCategoryDescription
        UpdateButtons Me, 4, 1, 0, 0, 0, 1
...
Private Function SeekRecord()
    ...
    blnEnableDelete = SimpleSeek("InvoicesIn", "InvoiceInExpenseCategoryID", grdExpenseCategories.CellValue(grdExpenseCategories.CurRow, 1))
    
    If MainSeekRecord("CommonDB", "ExpensesCategories", "ExpenseCategoryID", grdExpenseCategories.CellValue(grdExpenseCategories.CurRow, 1), True, txtExpenseCategoryID, txtExpenseCategoryDescription) Then
        blnStatus = False
        lngSelectedRow = grdExpenseCategories.CurRow
        EnableFields txtExpenseCategoryDescription
...
Private Sub Form_Load()
    ...
    SetUpGrid lstIconList, grdExpenseCategories
    ClearFields txtExpenseCategoryID, txtExpenseCategoryDescription
    DisableFields txtExpenseCategoryDescription
    UpdateButtons Me, 4, 1, 0, 0, 0, 1
